 ...
 */
const st = globalThis, bt = st.ShadowRoot && (st.ShadyCSS === void 0 || st.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, yt = Symbol(), Tt = /* @__PURE__ */ new WeakMap();
let ie = class {
  constructor(t, s, i) {
...
}, Ht = bt ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let s = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: xe, defineProperty: Ce, getOwnPropertyDescriptor: Ae, getOwnPropertyNames: Se, getOwnPropertySymbols: Ee, getPrototypeOf: Oe } = Object, O = globalThis, Pt = O.trustedTypes, Me = Pt ? Pt.emptyScript : "", dt = O.reactiveElementPolyfillSupport, q = (e, t) => e, it = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Me : null;
      break;
  ...
  return s;
} }, wt = (e, t) => !xe(e, t), Nt = { attribute: !0, type: String, converter: it, reflect: !1, useDefault: !1, hasChanged: wt };
...
let R = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(q("properties"))) {
      const s = this.properties, i = [...Se(s), ...Ee(s)];
  ...
  _$ET(t, s) {
    ...
    if (r !== void 0 && i.reflect === !0) {
      const o = (((n = i.converter) == null ? void 0 : n.toAttribute) !== void 0 ? i.converter : it).toAttribute(s, i.type);
  ...
  _$AK(t, s) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const h = i.getPropertyOptions(r), c = typeof h.converter == "function" ? { fromAttribute: h.converter } : ((n = h.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? h.converter : it;
      this._$Em = r;
  ...
  requestUpdate(t, s, i, r = !1, n) {
    ...
    if (t !== void 0) {
      ...
      if (r === !1 && (n = this[t]), i ?? (i = h.getPropertyOptions(t)), !((i.hasChanged ?? wt)(n, s) || i.useDefault && i.reflect && n === ((o = this._$Ej) == null ? void 0 : o.get(t)) && !this.hasAttribute(h._$Eu(t, i)))) return;
      this.C(t, s, i);
    }
...
R.elementStyles = [], R.shadowRootOptions = { mode: "open" }, R[q("elementProperties")] = /* @__PURE__ */ new Map(), R[q("finalized")] = /* @__PURE__ */ new Map(), dt == null || dt({ ReactiveElement: R }), (O.reactiveElementVersions ?? (O.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const W = globalThis, Lt = (e) => e, rt = W.trustedTypes, Zt = rt ? rt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, re = "$lit$", E = `lit$${Math.random().toFixed(9).slice(2)}$`, ne = "?" + E, Te = `<${ne}>`, L = document, K = () => L.createComment(""), F = (e) => e === null || typeof e != "object" && typeof e != "function", $t = Array.isArray, He = (e) => $t(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", ut = `[ 	
\f\r]`, D = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Bt = /-->/g, Rt = />/g, T = RegExp(`>|${ut}(?:([^\\s"'>=/]+)(${ut}*=${ut}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ut = /'/g, It = /"/g, oe = /^(?:script|style|textarea|title)$/i, Pe = (e) => (t, ...s) => ({ _$litType$: e, strings: t, values: s }), a = Pe(1), Z = Symbol.for("lit-noChange"), l = Symbol.for("lit-nothing"), zt = /* @__PURE__ */ new WeakMap(), P = L.createTreeWalker(L, 129);
function ae(e, t) {
...
const Ne = (e, t) => {
  ...
  for (let h = 0; h < s; h++) {
    const c = e[h];
    let u, v, p = -1, g = 0;
    for (; g < c.length && (o.lastIndex = g, v = o.exec(c), v !== null); ) g = o.lastIndex, o === D ? v[1] === "!--" ? o = Bt : v[1] !== void 0 ? o = Rt : v[2] !== void 0 ? (oe.test(v[2]) && (r = RegExp("</" + v[2], "g")), o = T) : v[3] !== void 0 && (o = T) : o === T ? v[0] === ">" ? (o = r ?? D, p = -1) : v[1] === void 0 ? p = -2 : (p = o.lastIndex - v[2].length, u = v[1], o = v[3] === void 0 ? T : v[3] === '"' ? It : Ut) : o === It || o === Ut ? o = T : o === Bt || o === Rt ? o = D : (o = T, r = void 0);
    const f = o === T && e[h + 1].startsWith("/>") ? " " : "";
    n += o === D ? c + Te : p >= 0 ? (i.push(u), c.slice(0, p) + re + c.slice(p) + E + f) : c + E + (p === -2 ? h : f);
  }
  return [ae(e, n + (e[s] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), i];
};
class G {
  constructor({ strings: t, _$litType$: s }, i) {
    ...
    this.parts = [];
    let n = 0, o = 0;
    const h = t.length - 1, c = this.parts, [u, v] = Ne(t, s);
    if (this.el = G.createElement(u, i), P.currentNode = this.el.content, s === 2 || s === 3) {
      const p = this.el.content.firstChild;
      p.replaceWith(...p.childNodes);
    }
    for (; (r = P.nextNode()) !== null && c.length < h; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const p of r.getAttributeNames()) if (p.endsWith(re)) {
          const g = v[o++], f = r.getAttribute(p).split(E), b = /([.?@])?(.*)/.exec(g);
          c.push({ type: 1, index: n, name: b[2], strings: f, ctor: b[1] === "." ? Ze : b[1] === "?" ? Be : b[1] === "@" ? Re : ct }), r.removeAttribute(p);
        } else p.startsWith(E) && (c.push({ type: 6, index: n }), r.removeAttribute(p));
        if (oe.test(r.tagName)) {
          const p = r.textContent.split(E), g = p.length - 1;
          if (g > 0) {
            r.textContent = rt ? rt.emptyScript : "";
            for (let f = 0; f < g; f++) r.append(p[f], K()), P.nextNode(), c.push({ type: 2, index: ++n });
            r.append(p[g], K());
          }
        }
      } else if (r.nodeType === 8) if (r.data === ne) c.push({ type: 2, index: n });
      else {
        let p = -1;
        for (; (p = r.data.indexOf(E, p + 1)) !== -1; ) c.push({ type: 7, index: n }), p += E.length - 1;
      }
      n++;
    }
  }
...
function U(e, t, s = e, i) {
  ...
  return (r == null ? void 0 : r.constructor) !== n && ((h = r == null ? void 0 : r._$AO) == null || h.call(r, !1), n === void 0 ? r = void 0 : (r = new n(e), r._$AT(e, s, i)), i !== void 0 ? (s._$Co ?? (s._$Co = []))[i] = r : s._$Cl = r), r !== void 0 && (t = U(e, r._$AS(e, t.values), r, i)), t;
}
class Le {
  constructor(t, s) {
  ...
  u(t) {
    const { el: { content: s }, parts: i } = this._$AD, r = ((t == null ? void 0 : t.creationScope) ?? L).importNode(s, !0);
    P.currentNode = r;
    let n = P.nextNode(), o = 0, h = 0, c = i[0];
    for (; c !== void 0; ) {
      if (o === c.index) {
        let u;
        c.type === 2 ? u = new Q(n, n.nextSibling, this, t) : c.type === 1 ? u = new c.ctor(n, c.name, c.strings, this, t) : c.type === 6 && (u = new Ue(n, this, t)), this._$AV.push(u), c = i[++h];
      }
      o !== (c == null ? void 0 : c.index) && (n = P.nextNode(), o++);
    }
    return P.currentNode = L, r;
  }
  p(t) {
    let s = 0;
...
class Q {
  ...
  $(t) {
    var n;
    const { values: s, _$litType$: i } = t, r = typeof i == "number" ? this._$AC(t) : (i.el === void 0 && (i.el = G.createElement(ae(i.h, i.h[0]), this.options)), i);
    if (((n = this._$AH) == null ? void 0 : n._$AD) === r) this._$AH.p(s);
    else {
      const o = new Le(r, this), h = o.u(this.options);
      o.p(s), this.T(h), this._$AH = o;
    }
  }
  _$AC(t) {
    let s = zt.get(t.strings);
    return s === void 0 && zt.set(t.strings, s = new G(t)), s;
  }
  k(t) {
    $t(this._$AH) || (this._$AH = [], this._$AR());
    const s = this._$AH;
    let i, r = 0;
    for (const n of t) r === s.length ? s.push(i = new Q(this.O(K()), this.O(K()), this, this.options)) : i = s[r], i._$AI(n), r++;
...
class ct {
  ...
  _$AI(t, s = this, i, r) {
    ...
    if (n === void 0) t = U(this, t, s, 0), o = !F(t) || t !== this._$AH && t !== Z, o && (this._$AH = t);
      ...
      const h = t;
      let c, u;
      for (t = n[0], c = 0; c < n.length - 1; c++) u = U(this, h[i + c], s, c), u === Z && (u = this._$AH[c]), o || (o = !F(u) || u !== this._$AH[c]), u === l ? t = l : t !== l && (t += (u ?? "") + n[c + 1]), this._$AH[c] = u;
    }
    o && !r && this.j(t);
  }
  j(t) {
...
pt == null || pt(G, Q), (W.litHtmlVersions ?? (W.litHtmlVersions = [])).push("3.3.3");
const Ie = (e, t, s) => {
  const i = (s == null ? void 0 : s.renderBefore) ?? t;
  let r = i._$litPart$;
  if (r === void 0) {
    const n = (s == null ? void 0 : s.renderBefore) ?? null;
    i._$litPart$ = r = new Q(t.insertBefore(K(), n), n, void 0, s ?? {});
  }
  return r._$AI(e), r;
};
/**
...
var se;
A._$litElement$ = !0, A.finalized = !0, (se = N.litElementHydrateSupport) == null || se.call(N, { LitElement: A });
const vt = N.litElementPolyfillSupport;
vt == null || vt({ LitElement: A });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ze = { attribute: !0, type: String, converter: it, reflect: !1, hasChanged: wt }, Ve = (e = ze, t, s) => {
...
function B(e) {
  return (t, s) => typeof s == "object" ? Ve(e, t, s) : ((i, r, n) => {
...
function m(e, t, s) {
  var n;
  const i = `component.${kt}.entity.${t}.${s}.name`, r = ce(e, i);
  return r || (((n = De[t]) == null ? void 0 : n[s]) ?? s);
}
function le(e, t, s, i) {
  var h, c;
  if (!i)
    return "—";
  const r = i.toLowerCase(), n = `component.${kt}.entity.${t}.${s}.state.${r}`, o = ce(e, n);
  return o || (((c = (h = qe[t]) == null ? void 0 : h[s]) == null ? void 0 : c[r]) ?? i);
}
function Ke(e, t) {
  const s = d(e, "status.hv_prefix"), i = le(
    e,
    "sensor",
    "hv_state",
    t || "unknown"
...
async function xt(e) {
  return !(e != null && e.loadBackendTranslation) || Vt ? !1 : (et || (et = e.loadBackendTranslation("entity", kt).then(() => (Vt = !0, !0)).catch((t) => (console.warn("carlinko-card: failed to load entity translations", t), et = void 0, !1))), et);
}
const jt = "carlinko";
function Fe(e, t) {
...
function Qe(e, t, s, i) {
  ...
  for (const c of Object.values(r)) {
    ...
    i.includes(u) && Fe(c, s) && n.push(c);
  }
  if (n.length === 0)
    return;
  const o = [...n].sort((c, u) => {
    const v = c.platform === jt ? 0 : 1, p = u.platform === jt ? 0 : 1;
    return v - p;
  });
  return (o.find((c) => Je(e, c.entity_id)) ?? o[0]).entity_id;
}
function Xe(e, t, s) {
  var o, h;
  if (!e)
  ...
  for (const c of n) {
    const u = Ge(s.domain, c), v = Qe(e, r, c, u);
    if (v)
      return v;
  }
}
...
class At {
  ...
  get(t, s, i) {
    ...
    return this._map && this._deviceId === r && this._imageEntity === n && this._entitiesJson === o && this._entitiesRef === h ? this._map : (this._map = ts(t, s, i), this._deviceId = r, this._imageEntity = n, this._entitiesJson = o, this._entitiesRef = h, this._map);
  }
}
const es = [
...
function de(e, t, s) {
  return rs(e, t) ? "danger" : y(e, s) === "check_tyres" ? "warn" : "ok";
}
function x(e, t, s = "—") {
  const i = j(e, t);
...
function ue(e, t) {
  ...
  return typeof r == "string" && r ? gt(
    e,
    `/api/image_proxy/${t}?token=${encodeURIComponent(r)}`
  ) : gt(e, `/api/image_proxy/${t}`);
}
...
function fs(e, t) {
  const s = j(e, t), i = s == null ? void 0 : s.attributes.options;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ks = { ATTRIBUTE: 1 }, xs = (e) => (...t) => ({ _$litDirective$: e, values: t });
let Cs = class {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ge = "important", As = " !" + ge, Ss = xs(class extends Cs {
  constructor(e) {
    var t;
    if (super(e), e.type !== ks.ATTRIBUTE || e.name !== "style" || ((t = e.strings) == null ? void 0 : t.length) > 2) throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.");
  }
  render(e) {
  ...
  update(e, [t]) {
    ...
    for (const i in t) {
      ...
      if (r != null) {
        ...
        i.includes("-") || n ? s.setProperty(i, n ? r.slice(0, -11) : r, n ? ge : "") : s[i] = r;
      }
    }
    return Z;
  }
...
function Es(e) {
  ...
  if (t === void 0 && !s)
    return l;
  const r = t === void 0 || Number.isNaN(t) ? void 0 : Math.max(0, Math.min(100, t)), n = r === void 0 ? 0 : Math.round(r), o = r !== void 0 ? `${n}% ${i}` : i, h = r !== void 0 ? Ss({ "--ck-soc-pct": `${n}%` }) : l, c = a`
    <div
...
var Ms = Object.defineProperty, Ts = Object.getOwnPropertyDescriptor, fe = (e, t, s, i) => {
  for (var r = i > 1 ? void 0 : i ? Ts(t, s) : t, n = e.length - 1, o; n >= 0; n--)
...
var Hs = Object.defineProperty, Ps = Object.getOwnPropertyDescriptor, _e = (e, t, s, i) => {
...
var Ns = Object.defineProperty, Ls = Object.getOwnPropertyDescriptor, Et = (e, t, s, i) => {
  for (var r = i > 1 ? void 0 : i ? Ls(t, s) : t, n = e.length - 1, o; n >= 0; n--)
    (o = e[n]) && (r = (i ? o(t, s, r) : o(r)) || r);
  return i && r && Ns(t, s, r), r;
};
function Zs(e, t) {
  const s = (t || "unknown").toLowerCase(), i = Ke(e, s);
  switch (s) {
    case "ready":
...
let Y = class extends A {
  constructor() {
    super(...arguments), this._slotCache = new At();
  }
  setConfig(e) {
  ...
  shouldUpdate(e) {
    ...
    if (e.has("hass")) {
      ...
      return s ? Ct(t, this.hass, Object.values(s)) : !0;
    }
    return !0;
  }
  updated(e) {
    e.has("hass") && this.hass && xt(this.hass).then((t) => {
      t && this.requestUpdate();
    });
  }
  _slots() {
    return this._config ? this._slotCache.get(this.hass, this._config, es) : {};
  }
  render() {
    var Mt;
    if (!this._config)
      ...
      >`;
    if (!((Mt = this._config.device_id) != null && Mt.trim()))
      return a`<ha-card
    ...
    if (!this.hass)
      ...
      >`;
    const e = this._slots(), t = ue(this.hass, e.image), s = J(this.hass, e.engine), i = J(this.hass, e.online), r = nt(this.hass, e.battery), n = nt(this.hass, e.fuel), o = e.odometer && this.hass.states[e.odometer] ? x(this.hass, e.odometer) : void 0, h = e.total_range && this.hass.states[e.total_range] ? x(this.hass, e.total_range) : void 0, c = s && e.engine && e.speed && this.hass.states[e.speed] ? x(this.hass, e.speed) : void 0, u = e.range && this.hass.states[e.range] ? x(this.hass, e.range) : void 0, v = e.fuel_range && this.hass.states[e.fuel_range] ? x(this.hass, e.fuel_range) : void 0, p = y(this.hass, e.hv_state), g = e.hv_state ? Zs(this.hass, p) : void 0, f = e.consumption && this.hass.states[e.consumption] ? x(this.hass, e.consumption) : void 0, b = e.fuel_consumption && this.hass.states[e.fuel_consumption] ? x(this.hass, e.fuel_consumption) : void 0, S = !!(o || h || c), $ = e.tyres_ok || e.tyre_status ? de(this.hass, e.tyres_ok, e.tyre_status) : void 0, we = $ === "danger" ? m(this.hass, "binary_sensor", "tyres_ok") : $ === "warn" ? le(this.hass, "sensor", "tyre_status", "check_tyres") : d(this.hass, "status.tyres_ok"), Ot = e.tyres_ok ?? e.tyre_status;
    return a`
      <ha-card>
...
var Bs = Object.defineProperty, me = (e, t, s, i) => {
...
var Us = Object.getOwnPropertyDescriptor, Is = (e, t, s, i) => {
...
var zs = Object.defineProperty, Vs = Object.getOwnPropertyDescriptor, lt = (e, t, s, i) => {
  for (var r = i > 1 ? void 0 : i ? Vs(t, s) : t, n = e.length - 1, o; n >= 0; n--)
    (o = e[n]) && (r = (i ? o(t, s, r) : o(r)) || r);
...
let I = class extends A {
  constructor() {
    super(...arguments), this._busy = !1, this._slotCache = new At();
  }
  setConfig(e) {
    if (!e || typeof e.device_id != "string")
      throw new Error("device_id is required");
  ...
  render() {
    ...
    if (!this.hass)
      return a`<ha-card
        ><div class="pad">${d(void 0, "chrome.waiting_hass")}</div></ha-card
      >`;
    const e = this._slots(), t = J(this.hass, e.charging), s = nt(this.hass, e.battery), i = !!(e.battery && this.hass.states[e.battery]), r = !!(e.charging && this.hass.states[e.charging]), n = !!(e.charge_power && this.hass.states[e.charge_power]), o = !!(e.charge_remaining && this.hass.states[e.charge_remaining]), h = e.charge_state && this.hass.states[e.charge_state] || e.charge_mode && this.hass.states[e.charge_mode], c = !!(e.charge_stop && this.hass.states[e.charge_stop]) && he(this.hass, e.charge_mode), u = i || r || n || o, v = t ? m(this.hass, "binary_sensor", "charging") : d(this.hass, "status.not_charging"), p = t ? "ok" : "muted", g = x(this.hass, e.charge_power), f = ns(this.hass, e.charge_remaining), b = m(this.hass, "sensor", "battery"), S = d(this.hass, "status.soc");
    return a`
      <ha-card>
        ${this._config.title ? a`<div class="header">${this._config.title}</div>` : l}
        <div class="body-pad">
      ...
      disabled: this._busy,
      variant: "danger",
      onClick: () => this._run(() => H(this.hass, e.charge_stop))
    })}
              </div>
            ` : l}
      </ha-card>
...
var Ds = Object.getOwnPropertyDescriptor, qs = (e, t, s, i) => {
...
var Ws = Object.defineProperty, Ks = Object.getOwnPropertyDescriptor, ht = (e, t, s, i) => {
...
], Gs = ["tyre_fl", "tyre_fr", "tyre_rl", "tyre_rr"], Js = a`
  <svg viewBox="0 0 24 24" aria-hidden="true">
    <path
      fill="currentColor"
...
let z = class extends A {
  ...
  _nudgeTemp(e) {
    ...
    if (!this.hass || !t)
      return;
    const s = Kt(this.hass, t);
    if (s === void 0)
      return;
    const i = hs(this.hass, t), r = ds(this.hass, t), n = us(this.hass, t), o = Math.min(n, Math.max(r, s + e * i));
    this._run(() => vs(this.hass, t, o));
  }
  _toggleClimate() {
    const e = this._slots().climate;
    if (!this.hass || !e)
      return;
    const t = Ft(this.hass, e);
    this._run(
      () => ps(this.hass, e, t ? "off" : "cool")
    );
  }
  _cycleSelect(e) {
    if (!this.hass)
      return;
    const t = fs(this.hass, e);
    if (t.length === 0)
      return;
    const s = y(this.hass, e) ?? t[0], i = t.indexOf(s), r = t[(i + 1) % t.length];
    this._run(() => gs(this.hass, e, r));
  }
  _toggleBinary(e) {
    if (!this.hass)
      return;
    ...
    this._run(
      () => t ? qt(this.hass, e) : Dt(this.hass, e)
    );
  }
  _hasDirectTpms(e) {
    return this.hass ? Gs.some((t) => {
      const s = e[t];
      return !!(s && this.hass.states[s]);
    }) : !1;
  }
  _hasSeats(e) {
    return this.hass ? Xt.some((t) => {
  ...
  _seatControl(e, t) {
    ...
    if (!e || !((c = this.hass) != null && c.states[e]))
      return l;
    const s = y(this.hass, e), i = vi(e), r = t === "H" ? "heat" : "vent", n = t === "H" ? d(this.hass, "status.heat") : d(this.hass, "status.vent"), o = gi(s), h = i === "select" ? () => this._cycleSelect(e) : () => this._toggleBinary(e);
    return a`
      <button
        type="button"
        class="seat-btn ${r}"
  ...
  _wheelZone(e, t) {
    ...
    if (!r && !n)
      return l;
    const o = de(this.hass, t.tyres_ok, t.tyre_status);
    return a`
  ...
  _chargerConnected(e) {
    return he(this.hass, e.charge_mode);
  }
  _hasBodyControls(e) {
  ...
  _bodyActions(e) {
    ...
    if (!t && !u && !v && !r && !c && !o)
      return l;
    const g = y(this.hass, t) === "locked", f = J(this.hass, s), b = J(this.hass, r), S = !!(r != null && r.startsWith("binary_sensor.")), $ = y(this.hass, o) === "open";
    return a`
      ...
      variant: f ? "ok" : "danger",
      onClick: () => this._run(
        () => f ? qt(this.hass, s) : Dt(this.hass, s)
      )
    }) : l}
            ${v ? _({
      ...
      icon: pi,
      disabled: this._busy,
      onClick: () => this._run(() => H(this.hass, i))
    }) : l}
          </div>` : l}
      ...
      variant: g ? "ok" : "danger",
      onClick: () => this._run(
        () => g ? as(this.hass, t) : os(this.hass, t)
      )
    })}
          </div>` : l}
      ...
      variant: b ? "danger" : "",
      onClick: () => this._run(() => cs(this.hass, r))
    })}
          </div>` : l}
      ...
      disabled: this._busy,
      variant: "danger",
      onClick: () => this._run(() => H(this.hass, n))
    })}
          </div>` : l}
  ...
  render() {
    ...
    if (!this.hass)
      return a`<ha-card
        ><div class="pad">${d(void 0, "chrome.waiting_hass")}</div></ha-card
      >`;
    const e = this._slots(), t = e.climate, s = t ? this.hass.states[t] : void 0, i = Ft(this.hass, t), r = Kt(this.hass, t), n = ls(this.hass, t), o = (typeof (s == null ? void 0 : s.attributes.temperature_unit) == "string" ? s.attributes.temperature_unit : void 0) || (typeof (s == null ? void 0 : s.attributes.unit_of_measurement) == "string" ? s.attributes.unit_of_measurement : "°C"), h = this._hasSeats(e), c = this._hasDirectTpms(e), u = this._hasWindowsControls(e), v = this._hasBodyControls(e), p = ue(this.hass, e.image), g = h || c || u || v, f = !!(s || e.quick_cool && this.hass.states[e.quick_cool] || e.quick_heat && this.hass.states[e.quick_heat]);
    return a`
      <ha-card>
        ${this._config.title ? a`<div class="header">${this._config.title}</div>` : l}
        <div class="body-pad">
        ...
        () => H(this.hass, e.quick_heat)
          ...
          ${g ? a`
                <carlinko-car-outline .src=${p}>
                  ...
                  ${Xt.map((S) => this._seatZone(S, e))}
                  ${c ? Fs.map((S) => this._wheelZone(S, e)) : l}
